...
const VERSION = '0.1.0';
const customRoot = path.join(__dirname, 'custom-pieces-tick-cron/dist');
...
console.log('[build-piece-tick-cron] done ->', pkgDir);
console.log('[build-piece-tick-cron] AP_CUSTOM_PIECES_PATHS=', customRoot);