// Builds our own @automators/piece-echo-auth into a custom-pieces layout the
// engine's piece-loader can resolve via AP_CUSTOM_PIECES_PATHS.
//   <custom>/pieces/@automators/piece-echo-auth-0.1.0/node_modules/@automators/piece-echo-auth/
...
const PIECE_SRC = path.join(__dirname, 'custom-pieces-echo/src/index.ts');

const PIECE = '@automators/piece-echo-auth';
const VERSION = '0.1.0';
const customRoot = path.join(__dirname, 'custom-pieces-echo/dist');
...
console.log('[build-piece-echo] done ->', pkgDir);
console.log('[build-piece-echo] AP_CUSTOM_PIECES_PATHS=', customRoot);
