...
const PIECE_SRC = path.join(__dirname, 'custom-pieces-tick/src/index.ts');

const PIECE = '@automators/piece-tick';
const VERSION = '0.1.0';
const customRoot = path.join(__dirname, 'custom-pieces-tick/dist');
...
console.log('[build-piece-tick] done ->', pkgDir);
console.log('[build-piece-tick] AP_CUSTOM_PIECES_PATHS=', customRoot);
