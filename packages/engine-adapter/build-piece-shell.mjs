// Builds our own @automators/piece-shell into a custom-pieces layout the
// engine's piece-loader can resolve via AP_CUSTOM_PIECES_PATHS.
//   <custom>/pieces/@automators/piece-shell-0.1.0/node_modules/@automators/piece-shell/
...
const PIECE_SRC = path.join(__dirname, 'custom-pieces-shell/src/index.ts');

const PIECE = '@automators/piece-shell';
const VERSION = '0.1.0';
const customRoot = path.join(__dirname, 'custom-pieces-shell/dist');
...
console.log('[build-piece-shell] done ->', pkgDir);
console.log('[build-piece-shell] AP_CUSTOM_PIECES_PATHS=', customRoot);